...
from fastapi.security import OAuth2PasswordRequestForm  #documentação, responsável por identificar que determinados endpoints precisamd e autenticação
...
# GET Logado
# url do usuário que foi autenticado
